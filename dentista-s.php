            ...
            <div class=cuerpo>
                <table>
                    ...
                    <?php
                        ...
                        $sql = "SELECT id, clients.dni, clients.nombre, clients.apellido, fecha, horario, estado FROM turno JOIN clients WHERE turno.dni_cliente = clients.dni && turno.estado = 'no confirmado';";
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo 
                                    "<tr>
                                        ...
                                        <td>". $row["fecha"]. "</td>
                                        <td>". $row["horario"]. "</td>
                                        <td><a href = 'confirm.php?rn=$row[id]'>Confirm</td>
                                    </tr>"
                                 ;
                            }
                        echo "</table>";
